 ...
 */
class PlanProject extends ComponentBase
{
    use CurrentLocale;
    ...
    public function onRun()
    {
        if($tenderID = $this->param('id')) {
            ...
            $tender = Plan::find($tenderID);
            $this->page['tender'] = $tender->getJson();
            $this->page['user_plan'] = $tender;
    ...
    {
        return $this->renderPartial('planproject/index');
    }
