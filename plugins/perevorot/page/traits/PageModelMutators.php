...
trait PageModelMutators
{
    ...
    public function setUrlAttribute($value)
    {
        switch ($this->type)
        {
            case $this::PAGE_TYPE_CMS: {
                ...
                $page = array_first($pages, function ($item, $key) use ($fileName) {
    ...
    public function getPageUrlAttribute()
    {
        ...
        switch($this->type)
        {
            ...
            case $this::PAGE_TYPE_ALIAS:
                $page_url=$this->alias_page->pageUrl;

                $href=!empty($page_url) ? $page_url : '';
    ...
    public function getHrefAttribute()
    {
        ...
        if($this->type!=self::PAGE_TYPE_EXTERNAL)
            $href=(!$this->isDefaultLocale ? '/'.$this->activeLocale : '').$href;
