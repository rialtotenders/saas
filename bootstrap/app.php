...
class HttpKernel extends \October\Rain\Foundation\Http\Kernel
{
    protected $bootstrappers = [
        ...
        '\Perevorot\Rialtotender\Classes\LoadEnvironmentVariables',
...
$app->singleton(
    ...
    Perevorot\Rialtotender\Classes\Handler::class
);

$app->singleton(
    October\Rain\Foundation\Bootstrap\ConfigureLogging::class,
    Perevorot\Rialtotender\Classes\ConfigureLogging::class
);
