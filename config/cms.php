...
return [
    ...
    */
    ...
    'activeTheme' => env('ACTIVE_THEME', 'rialtotender'),
    ...
    */
    ...
    'themesPath'      => env('THEMES_PUBLIC_PATH', '/themes'),
    'themesPathLocal' => env('THEMES_PATH', base_path('/themes')),
    /*
    |--------------------------------------------------------------------------
    | Resource storage
    |--------------------------------------------------------------------------
    ...
    */
    ...
    'storage' => [
        ...
        'media' => [
            'disk'   => 'local',
            'folder' => 'media',
            'path'   => env('MEDIA_PATH', '/storage/app/media'),
        ],
    ...
    */
    ...
    'linkPolicy' => env('LINK_POLICY', 'insecure'),
    ...
    */
    ...
    // 'fileDefinitions' => [
    //     'blockedExtensions' => [
    //         'asp', 'avfp', 'aspx', 'cshtml', 'cfm', 'go', 'gsp', 'hs', 'jsp', 'ssjs', 'js', 'lasso', 'lp', 'op', 'lua', 'p', 'cgi', 'ipl', 'pl', 'php', 'php3', 'php4', 'phtml', 'py', 'rhtml', 'rb', 'rbw', 'smx', 'tcl', 'dna', 'tpl', 'r', 'w', 'wig'
    //     ],
    // ]
];
